        ...
        >
          ...
          <React.Fragment>
            ...
            <div className=" d-flex ml-md-4 mt-2 my-md-auto">
              <Link
                href={"https://www.linkedin.com/in/thomas-gil-react-developer/"}
              >
                <div
                  title="Mon profile Linkedin"
                  className={`${styles.socialButton} d-flex align-items-center justify-content-center`}
                >
                  <svg
