...
const LegalMentions = () => {
  ...
  return (
    ...
    id="top"
      className={
        theme && theme === "light"
          ? `${styles.padding_from_top} mx-0`
          : `${styles.padding_from_top} bg-realy-dark text-white mx-0`
      }
    >
      <Col md={10} className="mx-auto">
        <h1 className="text-center mb-5">Informations légales</h1>
        <h3>1. Présentation du site.</h3>
        <p>
          En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la
          confiance dans l'économie numérique, il est précisé aux utilisateurs
          du site <a href="http://thomas-gil.fr/">thomas-gil.fr</a> l'identité
          des différents intervenants dans le cadre de sa réalisation et de son
          suivi :
        </p>
        <p>
          <strong>Propriétaire</strong> : thomas Gil – Auto-entreprise
          53176003100025 – 22 Allée de la Pagerie
          <br />
          <strong>Créateur</strong> :{" "}
          <a href="https://thomas-gil.fr">thomas Gil</a>
          <br />
          ...
          Louis-B.-Mayer Laval, Québec Canada H7P 0G1
          <br />
          Crédits : <br />
        ...
        <p>
          ...
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a> implique
          ...
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a> sont donc invités à
        ...
        <p>
          Le site <a href="http://thomas-gil.fr/">thomas-gil.fr</a> est mis à
          jour régulièrement par thomas Gil. De la même façon, les mentions
        ...
        <p>
          Le site <a href="http://thomas-gil.fr/">thomas-gil.fr</a> a pour objet
          de fournir une information concernant l’ensemble des activités de la
          société.
        </p>
        <p>
          thomas Gil s’efforce de fournir sur le site{" "}
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a> des informations
        ...
        <p>
          ...
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a> sont données à titre
          indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site{" "}
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a> ne sont pas
        ...
        <p>
          ...
          thomas-gil.fr, et résultant soit de l’utilisation d’un matériel ne
        ...
        <p>
          ...
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a>.
        </p>
        <p>
        ...
        <p>
          ...
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a>, peuvent êtres
          recueillies : l'URL des liens par l'intermédiaire desquels
          l'utilisateur a accédé au site{" "}
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a>, le fournisseur
        ...
        <p>
          ...
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a>. L'utilisateur
          ...
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a> l’obligation ou non
        ...
        <p>
          ...
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a> n'est publiée à
          l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un
          support quelconque à des tiers. Seule l'hypothèse du rachat de thomas
          Gil et de ses droits permettrait la transmission des dites
        ...
        <p>
          Le site <a href="http://thomas-gil.fr/">thomas-gil.fr</a> contient un
          certain nombre de liens hypertextes vers d’autres sites, mis en place
          avec l’autorisation de thomas Gil. Cependant, thomas Gil n’a pas la
        ...
        <p>
          ...
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a> est susceptible de
        ...
        <p>
          ...
          <a href="http://thomas-gil.fr/">thomas-gil.fr</a> est soumis au droit
